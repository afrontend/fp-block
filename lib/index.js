...
const diffPanelItem = (a, b) => isNotBlank(b) ? createItem() : a ;
...
/*
 * const newMeteoritePanel = (missilePanel, meteoritePanel) => {
 *   const overlap = isOverlap(upPanel(missilePanel), downPanel(meteoritePanel));
 *   return overlap
 *     ? createMeteoritePanel()
 *     : downPanel(rotatePanel(meteoritePanel));
 * };
 */

const checkMeteoritePanel = ({ bgPanel, shuttlePanel, missilePanel, meteoritePanel }) => (
  {
    bgPanel,
    shuttlePanel,
    missilePanel,
    meteoritePanel: isEmptyPanel(meteoritePanel) ? createMeteoritePanel() : meteoritePanel,
  }
)
